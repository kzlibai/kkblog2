                    ...
                    <form id="myForm" method="post" class="layui-form white-bg radius" action="doWriteBlog">
                        <div class="layui-form-item"><label class="layui-form-label">标题</label>
                            <div class="layui-input-block">
                                <%--id隐藏,不输入则自动增长--%>
                                <input type="text" class="layui-hide" name="id" value="${articleUpdate.id}">
                                <input type="text" class="layui-input" name="title" placeholder="请输入标题" value="${articleUpdate.title}">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="category" lay-verify="required">
                                    <option value="${articleUpdate.category}">${articleUpdate.category}</option>
                        ...
                        <div class="layui-form-item"><label class="layui-form-label">内容</label>
                            <div class="layui-input-block"><textarea id="lay_edit" lay-verify="content"
                                                                     name="content" placeholder="请输入内容">${articleUpdate.content}</textarea></div>
                        </div>
